...
export function ConfiguracionPage() {
  return <Page>
    ...
    <section className="space-y-3"><SectionHeader title="Dispositivo" /><ActionCard to="/configuracion/sincronizacion" title="Sincronización entre celulares" description="Activación, emparejamiento, permisos y recuperación." icon={<Icon name="sincronizar" />} /><ActionCard to="/configuracion/modo" title="Modo del dispositivo" description="Operación o consulta según su vínculo actual." /></section>
