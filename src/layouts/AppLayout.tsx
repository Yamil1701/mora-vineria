...
export function AppLayout() {
  ...
  return <div className="min-h-screen bg-mora-fondo bg-[radial-gradient(circle_at_top,_rgba(215,38,143,0.09),_transparent_34rem)] text-white">
    ...
    <main ref={mainRef} id="contenido-principal" tabIndex={-1} className={`mx-auto min-h-screen w-full max-w-md px-4 pt-5 outline-none print:max-w-none print:px-0 print:pb-0 print:pt-0 ${enfocada ? "pb-[calc(env(safe-area-inset-bottom)+2rem)]" : "pb-[calc(env(safe-area-inset-bottom)+7rem)]"}`}><Outlet /></main>
